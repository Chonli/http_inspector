...
$NetworkLogCopyWith<NetworkLog> get copyWith => _$NetworkLogCopyWithImpl<NetworkLog>(this as NetworkLog, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkLog&&(identical(other.id, id) || other.id == id)&&(identical(other.url, url) || other.url == url)&&(identical(other.method, method) || other.method == method)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&const DeepCollectionEquality().equals(other.requestHeaders, requestHeaders)&&const DeepCollectionEquality().equals(other.requestBody, requestBody)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&const DeepCollectionEquality().equals(other.responseHeaders, responseHeaders)&&const DeepCollectionEquality().equals(other.responseBody, responseBody)&&(identical(other.durationMs, durationMs) || other.durationMs == durationMs)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}


@override
int get hashCode => Object.hash(runtimeType,id,url,method,timestamp,const DeepCollectionEquality().hash(requestHeaders),const DeepCollectionEquality().hash(requestBody),statusCode,const DeepCollectionEquality().hash(responseHeaders),const DeepCollectionEquality().hash(responseBody),durationMs,errorMessage,stackTrace);
...
/// @nodoc
class _$NetworkLogCopyWithImpl<$Res>
...
/// Create a copy of NetworkLog
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? url = null,Object? method = null,Object? timestamp = null,Object? requestHeaders = freezed,Object? requestBody = freezed,Object? statusCode = freezed,Object? responseHeaders = freezed,Object? responseBody = freezed,Object? durationMs = freezed,Object? errorMessage = freezed,Object? stackTrace = freezed,}) {
...
as dynamic,durationMs: freezed == durationMs ? _self.durationMs : durationMs // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NetworkLog value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NetworkLog value)  $default,){
final _that = this;
switch (_that) {
case _NetworkLog():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NetworkLog value)?  $default,){
final _that = this;
switch (_that) {
case _NetworkLog() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$NetworkLogCopyWith<_NetworkLog> get copyWith => __$NetworkLogCopyWithImpl<_NetworkLog>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NetworkLog&&(identical(other.id, id) || other.id == id)&&(identical(other.url, url) || other.url == url)&&(identical(other.method, method) || other.method == method)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&const DeepCollectionEquality().equals(other._requestHeaders, _requestHeaders)&&const DeepCollectionEquality().equals(other.requestBody, requestBody)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&const DeepCollectionEquality().equals(other._responseHeaders, _responseHeaders)&&const DeepCollectionEquality().equals(other.responseBody, responseBody)&&(identical(other.durationMs, durationMs) || other.durationMs == durationMs)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}


@override
int get hashCode => Object.hash(runtimeType,id,url,method,timestamp,const DeepCollectionEquality().hash(_requestHeaders),const DeepCollectionEquality().hash(requestBody),statusCode,const DeepCollectionEquality().hash(_responseHeaders),const DeepCollectionEquality().hash(responseBody),durationMs,errorMessage,stackTrace);
...
/// @nodoc
abstract mixin class _$NetworkLogCopyWith<$Res> implements $NetworkLogCopyWith<$Res> {
...
/// @nodoc
class __$NetworkLogCopyWithImpl<$Res>
    implements _$NetworkLogCopyWith<$Res> {
...
/// Create a copy of NetworkLog
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? url = null,Object? method = null,Object? timestamp = null,Object? requestHeaders = freezed,Object? requestBody = freezed,Object? statusCode = freezed,Object? responseHeaders = freezed,Object? responseBody = freezed,Object? durationMs = freezed,Object? errorMessage = freezed,Object? stackTrace = freezed,}) {
